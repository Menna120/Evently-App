package com.route.evently.ui.main.composables
...
fun EventlyBottomNavBar(
    isSelected: (MainDestination.BottomItemDestination) -> Boolean,
    onItemClick: (MainDestination.BottomItemDestination) -> Unit
) {
    val scheme = MaterialTheme.colorScheme
    val bottomNavItems = listOf(
        MainDestination.BottomItemDestination.Home,
        MainDestination.BottomItemDestination.Map,
        null,
        MainDestination.BottomItemDestination.Love,
        MainDestination.BottomItemDestination.Profile
    )
...
fun EventlyBottomNavBarPreview() {
    EventlyTheme {
        EventlyBottomNavBar(
            isSelected = { it == MainDestination.BottomItemDestination.Home },
            onItemClick = {}
        )
    }
}
